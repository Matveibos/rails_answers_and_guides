...
10. Дополнительные 10 страниц

            1. Проставить любые номера формул.
            2. Проставить номера глав в оглавлении
            3. Посмотреть как правильно оформлять титульник для диплома в нормах
            4.
            
            1. Расскажи про R квадрат (Коэффициент детерминации) на одну страницу
            2. Расскажи про jQuery и библиотеку chart js
            3. байесовский метод оценивания?
            4. Вставить страничку с нормированными формулами из другого источника.
            5. Может написать 2-ю главу по конфлюентному или двухфазной? Если там не сильно много формул.
